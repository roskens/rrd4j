...
class RrdGraphCmd extends RrdToolCmd implements RrdGraphConstants {
     ...
     */
    public RrdGraphDef getGraphDef() throws IllegalArgumentException, IOException {
	...
	private void parseLine(RrdGraphDef graphDef, String word) throws IllegalArgumentException {
	...
	private void parseArea(RrdGraphDef graphDef, String word) throws IllegalArgumentException {
		String[] tokens1 = new ColonSplitter(word).split();
		if (tokens1.length != 2 && tokens1.length != 3) {
	...
	private void parseStack(RrdGraphDef graphDef, String word) throws IllegalArgumentException {
		String[] tokens1 = new ColonSplitter(word).split();
		if (tokens1.length != 2 && tokens1.length != 3) {
	...
	private void parseHRule(RrdGraphDef graphDef, String word) throws IllegalArgumentException, IOException {
		String[] tokens1 = new ColonSplitter(word).split();
		if (tokens1.length < 2 || tokens1.length > 3) {
	...
	private void parseVRule(RrdGraphDef graphDef, String word) throws IllegalArgumentException {
		String[] tokens1 = new ColonSplitter(word).split();
		if (tokens1.length < 2 || tokens1.length > 3) {
	...
	private void parseComment(RrdGraphDef graphDef, String word) throws IllegalArgumentException {
	...
	private void parseDef(RrdGraphDef graphDef, String word) throws IllegalArgumentException {
		String[] tokens1 = new ColonSplitter(word).split();
		if (tokens1.length != 4) {
		...
		graphDef.datasource(tokens2[0], tokens2[1], tokens1[2], ConsolFun.valueOf(tokens1[3]));
	}

	private void parseCDef(RrdGraphDef graphDef, String word) throws IllegalArgumentException {
		String[] tokens1 = new ColonSplitter(word).split();
		if (tokens1.length != 2) {
	...
	private void parseVDef(RrdGraphDef graphDef, String word) throws IllegalArgumentException {
		String[] tokens1 = new ColonSplitter(word).split();
		if (tokens1.length != 2) {
			throw new IllegalArgumentException("Invalid VDEF specification: " + word);
		}
		String[] tokens2 = tokens1[1].split("=");
		if (tokens2.length != 2) {
			throw new IllegalArgumentException("Invalid VDEF specification: " + word);
                ...
                if (tokens3.length == 2)  {
                    graphDef.datasource(tokens2[0], tokens3[0], ConsolFun.valueOf(tokens3[1]));
                } else {
                    if (tokens3[2].equals("PERCENT")) {
                        graphDef.percentile(tokens2[0], tokens3[0], Double.parseDouble(tokens3[1]));
                    } else {
                        throw new IllegalArgumentException("Invalid VDEF specification: " + word);
                    }
                }
	...
	private void parsePrint(RrdGraphDef graphDef, String word) throws IllegalArgumentException {
		String[] tokens = new ColonSplitter(word).split();
		if (tokens.length != 4) {
			throw new IllegalArgumentException("Invalid PRINT specification: " + word);
		}
		graphDef.print(tokens[1], ConsolFun.valueOf(tokens[2]), tokens[3]);
	}

	private void parseGPrint(RrdGraphDef graphDef, String word) throws IllegalArgumentException {
		String[] tokens = new ColonSplitter(word).split();
		if (tokens.length != 4) {
			throw new IllegalArgumentException("Invalid GPRINT specification: " + word);
		}
		graphDef.gprint(tokens[1], ConsolFun.valueOf(tokens[2]), tokens[3]);
	}

	private void parseColors(RrdGraphDef graphDef, String[] colorOptions) throws IllegalArgumentException {
	...
	private void parseYGrid(RrdGraphDef graphDef, String ygrid) throws IllegalArgumentException, IOException {
		if (ygrid == null) {
			return;
		}
	...
	private void parseXGrid(RrdGraphDef graphDef, String xgrid) throws IllegalArgumentException, IOException {
		if (xgrid == null) {
			return;
		}
	...
	private int resolveUnit(String unitName) throws IllegalArgumentException {
