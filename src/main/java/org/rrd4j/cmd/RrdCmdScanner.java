...
class RrdCmdScanner {
	...
	RrdCmdScanner(String command) throws IllegalArgumentException {
	...
	RrdCmdScanner(List<String> command) throws IllegalArgumentException {
	...
	private String getOptionValue(String fullForm) throws IllegalArgumentException {
	...
	String[] getMultipleOptions(String shortForm, String longForm) throws IllegalArgumentException {
