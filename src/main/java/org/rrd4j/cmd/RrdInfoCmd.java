...
class RrdInfoCmd extends RrdToolCmd {
	...
	private String getInfo(RrdDb rrd) throws IOException {
		...
		for (int i = 0; i < rrd.getDsCount(); i++) {
			...
			b.append("ds[").append(ds.getName()).append("].type = \"").append(ds.getType()).append("\"\n");
			b.append("ds[").append(ds.getName()).append("].minimal_heartbeat = ").
					append(ds.getHeartbeat()).append("\n");
			b.append("ds[").append(ds.getName()).append("].min = ").append(ds.getMinValue()).append("\n");
			b.append("ds[").append(ds.getName()).append("].max = ").append(ds.getMaxValue()).append("\n");
			b.append("ds[").append(ds.getName()).append("].last_ds = ").append(ds.getLastValue()).append("\n");
			b.append("ds[").append(ds.getName()).append("].value = ").append(ds.getAccumValue()).append("\n");
			b.append("ds[").append(ds.getName()).append("].unknown_sec = ").append(ds.getNanSeconds()).append("\n");
		}
