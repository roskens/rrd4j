...
class RrdXportCmd extends RrdToolCmd implements RrdGraphConstants {
	...
	private String xport(boolean enumds) throws IllegalArgumentException, IOException {
		dproc.processData();
	...
	private void parseDef(String word) throws IllegalArgumentException {
	...
	private void parseCDef(String word) throws IllegalArgumentException {
	...
	private void parseVDef(String word) throws IllegalArgumentException {
...
/*
                if (tokens3.length == 2)  {
                    dproc.addDatasource(tokens2[0], tokens3[0], ConsolFun.valueOf(tokens3[1]));
                } else {
...
*/
	...
	private void parseXport(String word) throws IllegalArgumentException {
		// XPORT:vname[:legend]
